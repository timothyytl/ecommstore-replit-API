...
const URL = "https://newapiproject.timothyytl.repl.co/"
...
function createProducts(products) {
    let result = ''
    //  With foreach looping through the array, for each and every product, display the object using innerHTML
...
function setCartValues(cart) {
    ...
    // to ensure only have 2 decimals - toFixed(2)
...
function cartLogic() {
    ...
    cartContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('remove-item')) {
            ...
            cartContent.removeChild(deleteItem.parentElement.parentElement)
            removeItem(id)
